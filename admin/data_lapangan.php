...
?>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
            <h2 align="center">Data Lapangan</h2>
                <div class="table-responsive">
                    ...
                    ?>
                      <tr>
                          <td><img src="../assets/image/lapangan/<?php echo $r['foto_lapangan']; ?>" alt="gambar lapangan" height="50px" width="150px"></td>
                          <td><?php echo $r['id_lapangan']; ?></td>
                          <td><?php echo $r['nomer_lapangan']; ?></td>
                          <td><?php echo $r['jenis_lapangan']; ?></td>
                          <td><?php echo $r['harga_lapangan']; ?></td>
                          <td><?php echo $r['poin_lapangan']; ?></td>
                          <td><?php echo $r['harga_point']; ?></td>
                      </tr>
                    <?php
                    }?>
                    </tbody>
