...
if(isset($_SESSION["id_admin"])) {
    if(isset($_GET["confirm_id_pesanan"])){
        $id_pesanan = $_GET["confirm_id_pesanan"];
        $update = mysqli_query($koneksi,"UPDATE pesanan SET status_pesanan = 'Terkonfirmasi' WHERE id_pesanan = $id_pesanan ");
        $delete = mysqli_query($koneksi,"DELETE FROM bayar WHERE id_pesanan = $id_pesanan ");
        unset($_GET["confirm_id_pesanan"]);?>
        <script type='text/javascript'> 
        document.location = 'konfirmasi_pesanan.php';
            ...
            <h2 align="center">Konfirmasi Pembayaran</h2>
                <div class="table-responsive">
                    ...
                    <?php
                      ...
                      $sql = mysqli_query($koneksi,"SELECT * FROM bayar");
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a href="konfirmasi_pesanan.php?confirm_id_pesanan=<?php echo $r['id_pesanan']?>" class="btn btn-warning btn-xs"><i class="fas fa-check-circle"></i> Konfirmasi </a></td>
                      </tr>
                    <?php
                    }?>
